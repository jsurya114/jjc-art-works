  ...
  return (
    <div className="font-sans text-[#1a110a] bg-[#fffcfaf0] overflow-x-hidden pb-32">
      ...
      <section className="px-6">
        <div className="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-auto">
          {filteredProjects.map(project => (
            <div 
              key={project.id} 
              className={`${activeCategory === 'All' ? project.span : 'col-span-1'} ${activeCategory === 'All' ? project.height : 'h-[400px]'} relative rounded-2xl overflow-hidden group cursor-pointer shadow-sm hover:shadow-xl transition-all duration-500`}
            >
